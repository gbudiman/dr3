export default {
  ...
  basicAgricultural: {
    description:
      '5 Mind and 10 Minutes gathers 1 Basic, 1 Uncommon, 1 Rare, or 1 Named Herb. May spend up to 30 Mind and 60 Minutes in one go, but must be same Herb. Requires Active RP and Full Engagement. Interruption resets timer.',
    name: 'Basic Agricultural',
    startingPage: 114
  },
  basicArtisan: {
    description:
      '5 Mind and 20 Minutes to craft an item or to repair damaged or Broken armor or weapon. Requires Active RP and Full Engagement. Interruption resets timer and loses all materials.',
    name: 'Basic Artisan',
    startingPage: 114
  },
  basicAwareness: {
    description:
      '5 Mind, pointing at Target, and calling "Alert" reveals Target using Stealth symbol for 5 Minutes.',
  ...
  basicCriminalInfluence: {
    description:
      'Check-in tells User time and location of all criminal, guild-specific, and black market meetings. 5 Mind and 5 Minutes Active RP and Full Engagement disarms and recovers Basic traps. Once per event, User may see and buy 1 item from this skill’s buyer’s list. Allows use of this skill’s equipment.',
    name: 'Basic Criminal Influence',
    startingPage: 115
  },
  basicCulinary: {
    description:
      '5 Mind and 20 Minutes to craft item. Requires Active RP and Full Engagement. Interruption resets timer and loses all materials.',
    name: 'Basic Culinary',
    startingPage: 114
  },
  basicEducation: {
  ...
  basicFaithVessel: {
    description:
      '5 Mind, Active verbal RP, and Psionic Attack on Target of same faith to call "Psionics (Faith): Immune first Break Armor until next 12s." Does not stack.',
    name: 'Basic Faith Vessel',
    startingPage: 129
  },
  basicFaithfulMiracles: {
    description:
      '5 Mind and verbal prayer temporarily removes all following effects for immediate consumption: damage done by consuming or contact, Unconsciousness or Stun caused by consuming, and some plot effects.',
    name: 'Basic Faithful Miracles',
    startingPage: 129
  },
  basicFaithfulPatterns: {
    description:
      '5 Mind and 10 Minutes Active RP with Active Participation inducts one willing Target into faith of User.',
  ...
  basicForaging: {
    description:
      '5 Mind and 30 Minutes Active RP in woods or wilderness to get 1 Craftable Stone or 1 High Grade Lumber. 0 Mind to pick up Foraging cards for 1 Basic Herb or Scrap.',
    name: 'Basic Foraging',
    startingPage: 121
  },
  basicHunting: {
  ...
  basicLarceny: {
    description:
      '5 Mind and 2 Minutes Active RP and Full Engagement opens Basic lock. Interruption resets timer and Mind is lost. 5 Mind and successfully placing black clothespins unnoticed on the pockets or bags steals 1 random item card from Supply Bag. Aiming for an item displayed on Target requires a clothespin close to that item. Counts as CvC and requires Guide.',
    name: 'Basic Larceny',
    startingPage: 115
  },
  basicMalicious: {
  ...
  basicMedical: {
    description:
      '0 Mind and either: 2 Minutes of Full Engagement RP to stabilize Bleed Out; 1 minute Full Engagement to learn Target’s Fractures, total Body, current Body, whether they are under the effects of drugs or poisons, and Diseases; 1 minute to check if Target is dead, alive, Unconscious, or under an effect. Allows use of this skill’s equipment.',
    name: 'Basic Medical',
    startingPage: 114
  },
  ...
  basicNecrokinetics: {
    description:
      '5 Mind to listen silently to a post-death scene with that player’s permission. 50% chance of gaining a Fracture unless User chooses definite chance.',
    name: 'Basic Necrokinetics',
    startingPage: 128
  },
  basicPyrokinetics: {
    description:
      '5 Mind and Psionic Attack to call "Psionic: 5 Body" or "Psionic: Break (Blueprint, Brew, Meal, or Gizmo." Countered by Mental Endurance for damage and held items. Can be used as coup de gras.',
  ...
  basicTelekinetics: {
    description:
      '5 Mind, Psionic Attack, and call "Psionic: Drop (left hand or right hand) toward me." to cause Target to drop held item at least 1 step toward User. If 2 hands are required, then both hands are dropped.',
    name: 'Basic Telekinetics',
    startingPage: 128
  },
  basicTelepathy: {
    description:
      '5 Mind, Psionic Attack on Target Creature, make eye contact, and call "Psionic: Suggestion (no more than 3 words)". Causes Target Creature to follow until they are harmed, 10 Minutes have passed, their instructions would cause self-destruction, or they reach a point where the request is outside their capacities.',
  ...
  masterAgricultural: {
    description:
      '5 Mind and 10 Minutes to get 1 Produce or Infectious Material. User may spend up to 30 Mind and 60 Minutes in one go, but must be same Produce. May harvest out of season herbs with Basic Agricultural. Requires Active RP and Full Engagement. Interruption resets timer.',
    name: 'Master Agricultural',
    startingPage: 118
  },
  masterArtisan: {
    description:
      '15 Mind and 20 Minutes to craft an item from Proficient to Master, or 30 Mind from scratch to Master. Requires Active RP and Full Engagement. Interruption resets timer and loses all materials.',
    name: 'Master Artisan',
    startingPage: 118
  },
  masterAwareness: {
    description:
      '1 Resolve and 10 Minutes of Active RP for Target to call "No effect: Master Awareness." to Blinding and Blinding zone effects for 1 hour, and call "Master Awareness: Alert" while gesturing at a Target to negate a single Stealth skill for 5 Minutes at no cost once during the 1 hour.',
  ...
  masterCombatTactics: {
    description:
      '1 Resolve and a loud rally cry to call "10-foot radius: All allies heal 20 Body and are immune to Fear 10 Minutes."',
    name: 'Master Combat Tactics',
    startingPage: 113
  },
  masterCriminalInfluence: {
    description:
      'Considered Inner Cricle in local criminal organizations. Can submit an Action Request to get a job for up to 15 people maximum with some level of this skill. Reward is Gizmo: Free X Criminal Influence Voucher (X = level of skill of recipient) to view and get 1 free item from X level of this skill’s list. User may spend 5 trade notes for an item that may help during the mission. 10 Mind and 5 Minutes Active RP with Full Engagement to disarm and recover Master traps. Once per event, User may see and buy 1 item from this skill’s buyer’s list. Allows use of this skill’s equipment.',
    name: 'Master Criminal Influence',
    startingPage: 120
  },
  masterCulinary: {
    description:
      '15 Mind and 20 Minutes to craft item. Requires Active RP and Full Engagement. Interruption resets timer and loses all materials.',
    name: 'Master Culinary',
    startingPage: 119
  },
  masterEducation: {
    description:
      '5 Mind and 15 Minutes of Active RP to teach a skill the User possesses. Skill is immediately usable by Target. Grants 3 Lores.',
    name: 'Master Education',
    startingPage: 118
  },
  masterEnhancedMovement: {
    description:
      '20 Mind to take 10 steps (5 seconds) with out-of-character gesture up. Must be used from cover. Can end in a visible location. Cannot be negated by Awareness. Cannot be chained or linked with any other mechanic during movement.',
  ...
  masterFaithVessel: {
    description:
      '1 Resolve to gain 5 uses of ranged Psionic Attack "Heal 10 body recover 5 Mind". After 10 Minutes or all 5 uses, User becomes Unconscious and dropped into Bleed Out (0 hp) wherever they are.  Gains 2 Fractures.  Cannot be used while Fractured.',
  ...
  masterMalicious: {
    description:
      '1 Resolve and point at Target to ignore 20 seconds of strikes and effects while stalking towards the Target no more than 15 paces away. Must strike Target upon reaching, and will then begin taking damage and skill effects per normal.',
    name: 'Master Malicious',
    startingPage: 126
  },
  masterMedical: {
    description:
      '5 Mind and 5 Minutes of Active RP and Full Engagement to restore 15 Mind to the Target. May be a requirement to cure deadlier diseases.',
    name: 'Master Medical',
    startingPage: 118
  },
  masterMeleeSmall: {
  ...
  masterPyrokinetics: {
    description:
      '1 Resolve, Psionic Attack, and call "Psionic: Area of Effect - 30 Body, Break all brews." to affect all Targets in the area. Cannot be used while Fractured. Countered by Master Mental Endurance only. Counts as a CVC action when used against LCs or SCs.',
  ...
  masterStealth: {
    description:
      'Once per event, may spend 1 Resolve and declare "Never here." to put up the out-of-game symbol and go to logistics to appear in a different location.',
    name: 'Master Stealth',
    startingPage: 127
  },
  masterTelekinetics: {
    description:
      '1 Resolve, Psionic Attack, and call "Break all armor and brews." Countered by Mental Endurance. Cannot be used if User has a Fracture. Counts as CvC action against LCs or SCs.',
  ...
  piercingStrike: {
    description:
      '1 Mind for a single successful melee, unarmed, thrown, or projectile attack to take on the Body modifier and ignore armor. Overrides any pre-existing modifiers.',
    name: 'Piercing Strike',
    startingPage: 111
  },
  proficientAgricultural: {
    description:
      '5 Mind and 10 Minutes to get 1 Produce, other than Infectious Material. User may spend up to 30 Mind and 60 Minutes in one go, but must be same Produce. Requires Active RP and Full Engagement. Interruption resets timer.',
    name: 'Proficient Agricultural',
    startingPage: 116
  },
  proficientArtisan: {
    description:
      '10 Mind and 20 Minutes to craft items from Basic to Proficient. From Scratch to proficient requires requires 15 Mind. Active RP and Full Engagement. Interruption resets timer and loses all materials.',
  ...
  proficientBiogenetics: {
    description:
      '10 Mind, Psionic Attack, and call "Psionic: Unconscious." to cause a Target to be knocked Unconscious. Does not work on Zombies. Counts as CVC when used against LCs or SCs.',
    name: 'Proficient Biogenetics',
    startingPage: 130
  },
  proficientCombatTactics: {
    description:
      '10 Mind, gesture to up to 5 Targets in a 180-degree forward-facing arc, and call "Scattershot" to cause those Targets to be automatically hit by a single Strike or Ranged Attack. May be combined with equipment effects or skills, except single use items.',
    name: 'Proficient Combat Tactics',
    startingPage: 112
  },
  proficientCriminalInfluence: {
    description:
      'Allows User to give up to 3 item cards at 5 Mind per item to Logistics before criminal or black market meeting occurs, to be sold by an Extra during the meeting. 5 Mind and 5 Minutes disarms and recovers Proficient traps. Once per event, User may see and buy 1 item from this skill’s buyer’s list. Allows use of this skill’s equipment.',
    name: 'Proficient Criminal Influence',
    startingPage: 117
  },
  proficientCulinary: {
    description:
      '10 Mind and 20 Minutes to craft item. Requires Active RP and Full Engagement. Interruption resets timer and loses all materials.',
    name: 'Proficient Culinary',
    startingPage: 116
  },
  proficientEducation: {
    description:
      '1 Mind per person and 15 Minutes of Active RP to teach a skill possessed by User to as many people as participate. Skill is usable at next 12s. Grants 3 Lores.',
    name: 'Proficient Education',
    startingPage: 116
  },
  proficientEnhancedMovement: {
    description:
      '10 Mind to take 5 steps (max 3 seconds) out-of-character. Not countered by Awareness. Must be used starting from cover. Cannot be chained or linked with any other mechanic during movement.',
  ...
  proficientFaithfulPatterns: {
    description:
      '10 Mind, Active verbal RP, and Psionic Attack to call "Psionic Suggestion: Declare your faith and devotion." If Target is of the same faith, the Mind is refunded. May not knowingly reuse on Target for another hour. Countered by Mental Endurance but mute Targets will try to non-verbally answer.',
  ...
  proficientMentalEndurance: {
    description:
      '5 Mind and 10 Minutes of Active Participation with sentient Target, may ask o1 yes or no question about the Target’s skill set, short-term intent, or mind-set. Malicious use is considered a CVC action.',
  ...
  proficientPyrokinetics: {
    description:
      '10 Mind, Psionic Attack, and call "Psionic: 20 Body." Use of this skill causes the User’s hands to ash and char over time.',
  ...
  proficientSocialInfluence: {
    description:
      '10 Mind, 30 Minutes, and Active Participation with Target to resolve 1 Fracture.',
